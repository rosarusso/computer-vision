...
# triangle mesh, applying the X84 outlier filter.

def _distance(p1, p2):
    """Euclidean distance between two 3D points (both arrays)."""
...
def rangetomesh(valid_mask: np.ndarray,
    ...
    # Build dense vertex list and an index map (v_index) that tells for each pixel which vertex number it corresponds to.
    ...
    # Compute the X84 distance threshold (TX_X84)

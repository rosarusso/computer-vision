import numpy as np
# Perspective projection from 3D points to image pixel coordinates

def proj(P: np.ndarray, points_3d: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
    """
    Compute the perspective projection of 3D points.
    ...
    points_3d : (N, 3) array
        3D points expressed in the camera coordinate system.
